...
public class FileUtil {
     ...
     *
     * @param filePath
     *            path of the file. It can be an absolute path or a relative path to the OPI that contains the specified widget. If it is an absolute
     *            path, it can be either<br>
     *            a workspace path such as <code>/BOY Examples/Scripts/myfile.xml</code><br>
     *            a local file system path such as <code>C:\myfile.xml</code><br>
     *            or an URL path such as <code>http://mysite.com/myfile.xml</code>.
     * @param widget
     *            a widget in the OPI, which is used to provide relative path reference. It can be null if the path is an absolute path.
     * @return root element of the XML file.
     * @throws Exception
     *             if the file does not exist or is not a correct XML file.
     */
    ...
    /**
     * Return an {@link InputStream} of the file on the specified path. The client is responsible for closing the stream when finished.
     *
     * @param filePath
     *            path of the file. It can be an absolute path or a relative path to the OPI that contains the specified widget. If it is an absolute
     *            path, it can be either<br>
     ...
     * @param inWorkspace
     *            true if the file path is a workspace file path. Otherwise, it will be recognized as a local file system file.
     * @param text
     ...
     * @param filePath
     *            path of the file. It can be an absolute path or a relative path to the OPI that contains the specified widget. If it is an absolute
     *            path, it can be either a workspace path such as <br>
    ...
    /**
     * Convert a workspace path to system path. If this resource is a project that does not exist in the workspace, or a file or folder below such a
