...
public class OPIRuntimePreferencePage extends FieldEditorPreferencePage
    ...
    protected void createFieldEditors() {
        ...
        IntegerFieldEditor pvManagagerTimeout = new IntegerFieldEditor(PreferencesHelper.OPIBUILDER_PVMANAGER_TIMEOUT, "PVManager timeout (ms)", parent);
        pvManagagerTimeout.setValidRange(0, 5000);
