...
public class JMSAlarmMessage
{
    ...
    /** Value for TEXT that indicates a configuration change.
     *  NAME will contain path to item that was added, removed,
    ...
    /** Value for TEXT that indicates a PV was disabled.
    ...
    /** Value for TEXT that performs un-acknowledgment
     *  NAME will contain PV name
     */
